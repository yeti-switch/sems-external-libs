...
set(S3_INCLUDE_DIR ${S3_BIN_DIR}/include/s3)

execute_process(COMMAND ${CMAKE_COMMAND} -E copy_directory ${S3_SRC_DIR}/inc ${S3_INCLUDE_DIR})
...
install(DIRECTORY ${S3_INCLUDE_DIR} DESTINATION ${SEMS_THIRD_INCLUDE_PATH}
        FILES_MATCHING PATTERN "*.h")
install(FILES ${S3_BUNDLED_LIB} DESTINATION ${SEMS_THIRD_LIB_PATH})
